 ...
 * 
 */
public class HcWeiboFetchContentThread implements Callable<Map<String, Object>> {
	...
	public HcWeiboFetchContentThread(FetchParame fetchParame,
	...
	public List<Map<String, Object>> getArticleEachPage(String pageUrl) {
		...
		// 获取单独每页的文档信息
		Document docEachPage = HcLoginJsoupDocumentUtil.getDocument(pageUrl,
				this.extraParame, this.site.getSeedUrl());
		// 获取每个帖子div的元素集合
	...
	public Map<String, Object> call() throws Exception {
		...
		for (Post post : getPosts()) {
			...
			// 初始化第一页的document
			this.docPostFirstPage = HcLoginJsoupDocumentUtil.getDocument(post
