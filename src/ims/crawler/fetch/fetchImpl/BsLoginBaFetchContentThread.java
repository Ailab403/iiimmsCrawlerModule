...
public class BsLoginBaFetchContentThread implements
	...
	public BsLoginBaFetchContentThread(FetchParame fetchParame,
			GrabUserParame grabUserParame, ExtraParame extraParame,
			FetchPagerObj fetchPagerObj, Site site, TaskLog taskLog,
			Theme theme, Set<Post> posts) {
		super();
	...
	public List<Map<String, Object>> getArticleEachPage(String pageUrl) {
		...
		// 获取单独每页的文档信息
		Document docEachPage = BsLoginJsoupDocumentUtil
				.getDocument(pageUrl, this.extraParame, this.site.getSeedUrl(),
						this.site.getEnCode());
		// 获取每个帖子div的元素集合
	...
	public Map<String, Object> call() throws Exception {
		...
		for (Post post : getPosts()) {
			...
			// 初始化第一页的document
			this.docPostFirstPage = BsLoginJsoupDocumentUtil.getDocument(post
					.getPostUrl(), this.extraParame, this.site.getSeedUrl(),
					this.site.getEnCode());
