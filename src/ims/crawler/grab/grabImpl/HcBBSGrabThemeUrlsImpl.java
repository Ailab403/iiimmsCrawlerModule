 ...
 * 
 */
public class HcBBSGrabThemeUrlsImpl implements GrabThemeUrls {
	...
	public Set<Theme> getThemeUrlSet() {
		...
		// 从种子页面使用HttpClient方式载入html代码document
		Document docSeedPage = HcJsoupDocumentUtil.getDocument(site
				.getSeedUrl(), site.getSeedUrl(), site.getEnCode());
		if (docSeedPage == null) {
			return null;
		}
