...
-- 
-- 导出表中的数据 `tbl_category`
-- 

INSERT INTO `tbl_category` (`categoryId`, `categoryName`, `reqLogin`, `categoryExp`) VALUES 
...
CREATE TABLE IF NOT EXISTS `tbl_fetchpagerobj` (
  ...
  `fetchPagerObj` varchar(50) NOT NULL,
...
INSERT INTO `tbl_fetchpagerobj` (`fetchPagerObjId`, `fetchPagerObj`, `generalable`, `used`, `objExp`) VALUES 
...
(1, 1, 0, 'div#ba_list', 'div[class^=ba_info]', 'p.ba_name', 'a[class^=ba_href]', 'div#frs_list_pager', 'a.next', 'div#content_leftList', 'li[class*=thread]', 'a[class*=tit]', 'a[class*=tit]', 'div.threadlist_rep_num', 'div.threadlist_rep_num', '', 'span[class^=threadlist_reply_date]'),
(2, 2, 0, 'ul.block-ranking', 'li', 'a[href*=list]', 'a[href*=list]', 'div.links', 'a[rel=nofollow]', 'table[class^=tab-bbs-list]', 'tr:has(td[class^=td])', 'a[href*=post]', 'a[href*=post]', 'td:nth-child(3)', 'td:nth-child(4)', '', 'td[title^=20]'),
(3, 3, 0, 'ul[style$=block]', 'li[class^=active]', 'a[href]', 'a[href]', 'div.page', 'a.end', 'table.tiezi_table', 'tr[data-sid]', 'a[title]', 'a[title]', 'td:nth-child(3)', 'td:nth-child(3)', '', 'td.time'),
(4, 4, 0, 'ul[class^=top-15]', 'li[class^=li]', 'a', 'a', 'div.numb_post2', 'div>a:nth-child(3)', 'tbody', 'tr:has(td)', 'td.common>a[href*=viewthread]', 'td.common>a[href*=viewthread]', 'span.green', 'span.cRed', '', 'td[class$=kmhf]>em'),
(5, 5, 0, 'div#sub_nav', 'dd', 'a', 'a', 'div.pages', 'a.next', 'form[name=moderate]', 'tbody[class^=author_thread]', 'span[id^=thread]>a', 'span[id^=thread]>a', 'td.nums>strong', 'td.nums>em', '', 'td.lastpost a'),
...
CREATE TABLE IF NOT EXISTS `tbl_grabuserparame` (
  ...
  `postTimeLimit` datetime NOT NULL default '0000-00-00 00:00:00',
...
INSERT INTO `tbl_grabuserparame` (`grabUserParameId`, `siteId`, `categoryId`, `themePageNumLimit`, `postTimeLimit`, `postTimeRangeLimit`, `timeDeterminer`, `postClickNumLimit`, `postReplyNumLimit`, `postForwardNumLimit`) VALUES 
(1, 1, 0, 3, '2014-03-01 00:00:00', '00-01-00', 0, 0, 0, 0),
(2, 2, 0, 3, '2014-03-01 00:00:00', '00-01-00', 0, 0, 0, 0),
(3, 3, 0, 3, '2014-03-01 00:00:00', '00-01-00', 0, 0, 0, 0),
(4, 4, 0, 3, '2014-03-01 00:00:00', '00-01-00', 0, 0, 0, 0),
(5, 5, 0, 3, '2014-03-01 00:00:00', '00-01-00', 0, 0, 0, 0),
(6, 6, 1, 3, '2014-03-01 00:00:00', '00-01-00', 0, 0, 0, 0);
...
CREATE TABLE IF NOT EXISTS `tbl_sitelog` (
  ...
  `siteUpdateThemeNum` int(11) NOT NULL,
